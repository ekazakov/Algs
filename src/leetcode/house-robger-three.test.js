...
/*
Можно для каждого поддерева вычислять «добычу» при обходе начиная с корня
и при обходе начиная с детей. И возвращать пару чисел.

В базовом случае мы возвращаем [0,0]
А при выходе из рекурсии:
[
 «значение из корня + суммы обхода левого и правого поддера с пропуском их корня»,
 «максимум из обхода левого поддерва с корнем и без корня + максимум из обхода правого поддерева»
]
